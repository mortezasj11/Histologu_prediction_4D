...
def main():
    ...
    loss_CE = FocalLoss(reduction=hparams["reduction"])
    ...
    if model_train:
        ...
        for epoch in t:
            ...
            with torch.no_grad():
                ...
                print('t_label_pred',t_label_pred, t_label_pred.min(), t_label_pred.max())
            ...
            if (epoch + 1) % val_interval == 0:
                ...
                with torch.no_grad():
                    ...
                    breakpoint()
                    print('v_label_pred',v_label_pred,v_label_pred.min(), v_label_pred.max())
                    print('val_label',val_label,val_label.min(), val_label.max())
