...
from monai.networks.nets import UNet, AutoEncoder, VarAutoEncoder, ResNet
        ...
        for epoch in t:
            ...
            if epoch > skip_epoch_model:
                ...
                if metric1 > best_metric_pfs:
                    ...
                    torch.save(model.state_dict(), hparams["name"]+"_NOFOCAL_ACC_" + str(np.round(metric1*100)) + "_PFS.pth")
