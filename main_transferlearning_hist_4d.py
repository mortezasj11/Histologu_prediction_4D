...
class Dense_model(nn.Module):
    def __init__(self,drop_rate, in_channels):
        ...
        self.fc1 = torch.nn.Linear(1024, 3)
...
hparams = { 'lr' : 0.6e-3,
            ...
            'max_epochs' : 300,
            'train_batch' : 4,
            'weight' : torch.tensor([     0.5*(319+222)/(723+319+222)    ,     0.5*(723+222)/(723+319+222)    ,    0.5*(723+319)/(723+319+222)     ]),#723+319+222
...
def main():
    ...
    files_dir = '/Data/Histology/Nature_4D_Organized/TrainValTest/GEMINI_Nature_c'
    ...
    if model_train:
        ...
        writer = SummaryWriter(log_dir='runs_tf/' + time_stamp + '__randp_p5__NoL1_Using_precision_posWeight_p6')
        ...
        for epoch in t:
            ...
            with torch.no_grad():
                ...
                figure2 = plot_confusion_matrix(cm, class_names=['Ad','Sq','O'],normalize=False)
            ...
            if (epoch + 1) % val_interval == 0:
                ...
                with torch.no_grad():
                    ...
                    figure_v2 = plot_confusion_matrix(cm_v, class_names=['Ad','Sq','O'],normalize=False)
            ...
            if model_test:
                ...
                with torch.no_grad():
                    ...
                    figure_s = plot_confusion_matrix(cm, class_names=['Ad','Sq','O'])
                    _, torch_im_s = plt2arr(figure_s)
                    #writer.add_images('Val_2/CM', torch_im_s[:,0:3,:,:], epoch)

                    figure_s2 = plot_confusion_matrix(cm, class_names=['Ad','Sq','O'],normalize=False)
