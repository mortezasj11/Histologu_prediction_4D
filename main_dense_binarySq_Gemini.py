...
def main():
    ...
    train_os = pd.read_csv('/Data/Histology/Nature_Gemini_4d_Feb2022/TrainValTest/OnlyGemini2/train.csv')
    val_os   = pd.read_csv('/Data/Histology/Nature_Gemini_4d_Feb2022/TrainValTest/OnlyGemini2/val.csv')
    test_os  =  pd.read_csv('/Data/Histology/Nature_Gemini_4d_Feb2022/TrainValTest/OnlyGemini2/test.csv')
    ...
    if model_train:
        ...
        writer = SummaryWriter(log_dir='runs_BG/' + time_stamp + '__letssee')
